...
const shelter = {
    1: {
        ...
        "description": "Hex House is a 431-square-foot (40-square-metre) unit is largely made of steel-and-foam Structural Insulated Panels (SIPs), which can be flat-packed and delivered by truck to a building site. It was developed by Minnesota-based Architects for Society as a rapidly deployable dwelling that could house victims of catastrophic events. The design is meant to be scalable, and each home is intended to be occupied for 15 to 20 years. The estimated cost for each unit is between $15,000 and $20,000 (£10,600 and £14,000). Units can simply be arranged next to one another in appropriate patterns or they can be joined and share walls for enhanced thermal performance.",
        "altText1": "Hex House",
    ...
    4: {
        ...
        "description": "The earthquake of 26 December 2004 caused a catastrophic tsunami that took the life of 38,000 people. One of the devastated areas was Kirinda, a small community of fishermen located in the southern coast of the country. The reconstruction project, comprising fifty houses, was set forth as a collaborative process in which the population participated to adapt the design to its needs. Though the master plan suggested placing kitchens and bathrooms outside the house, they were finally included and separated from the rest of the rooms by a covered space that opens up to the exterior. This area of transition functions also as a gathering place among neighbors or as a workshop to repair the fishing nets.",
    ...
    7: {
        ...
        "description": "After the 2008 Wenchuan Earthquake in 200 total of twenty-two houses were rebuilt including a community center. The design strategy provides four types of houses, differing in size, function and their roof. These demonstrate new uses of local materials, a green stepped-roof, biogas technologies, and accommodation for pigs and chickens. A vertical courtyard increases light and ventilation and channels rainwater for collection. By relating various programs of the village to an ecological cycle, environment responsiveness is heightened, transforming the village into a model for nearby areas.",
    ...
    9: {
        ...
        "location": "Various",
        "architect": "Shigeru Ban",
        "description": "Shigeru Ban's novel innovation for emergency housing Paper Log House in Kobe, Japan was a thriving model. Noticing the beneficial use of the innovation, he furthermore introduced it to other countries around the world. Following it, Paper Log Houses have been built for earthquake survivors in Turkey and India, and served as a precedent for building shelter for those uprooted by genocide in Rwanda and for the design of transitional houses for refugees in Kosovo. Paper Log Houses equipped victims with more affordable and hygienic housing. The merit of the Paper Log House is not only the innovation of material but also the humanitarian concerns that it delivered to society.",
...
const community = {
    1: {
        ...
        "description": "Mason's bend, located deep in Alabama's cotton belt, is home to four extended families. Most live in trailers or poorly constructed homes. On a central site in Mason's Bend, the Glass Chapel serves as a transportation stop, community gathering space, chapel for the local choral group, and distribution center for children's summer school meals. Car windows salvaged from a Chicago scrap yard provide striking roofing material on the north side atop rammed earth walls. Anderson Harris, owner of the Butterfly House, donated the land for the center and before his recent death tended to its garden.",
    ...
    2: {
        ...
        "description": "Designed by students from Helsinki University, this red building centered on an internal courtyard, serves as the focal point for women's organisations. The building lies on a bed of clay, with a solid pillar foundation. Emphasis was given to local materials and recycling, using wheel rims from cars for vents, and 'glass bricks' for fenestration from bottom parts of old bottles. Run by local women, the complex provides facilities for social events and training, as well as a kindergarten and sewing school. Women's level of schooling is improved through independent initiatives and literacy courses.",
    ...
    7: {
        ...
        "description": "Tiuna El Fuerte is an experimental collective and a cultural centre in a marginalised suburb of Caracas (Venezuela). Over the past 15 years, our goal is to foster social transformation in communities in need through artistic expression and musical events in critical and conflict urban areas. It is meant to be a self-sufcient social environment based on participation protocols and community. Self-initiatives developed and built on an abandoned parking lot with local workers. This project emerges in a complex urban site; the area has been badly afected by slow infrastructure development and sufers from low quality social housing interventions by the state in the 70s.",
    ...
    9: {
        ...
        "description": "Urban-Think Tank's Vertical Gym is a prefabricated kit of parts, adaptable to any location. The base of the structure is superimposed upon an existing community basketball court, soccer field, or vacant lot, transforming it into a multi-level sports complex that can accommodate hundreds of people at a time. The design maximizes the potential of any city space, particularly areas with a dense urban fabric. U-TT believes that engaging in exercise and social activity is a right of all citizens in the city, no matter their social and economic backgrounds.",
...
const water = {
    ...
    4: {
        ...
        "location": "Various",
        "architect": "IDEO",
        "description": "MoneyMaker pumps are low-cost, high-quality irrigation technologies designed for small-scale farmers in Africa. Entrepreneurial farmers are irrigating with KMoneyMaker irrigation pump to change their small subsistence farms into commercial enterprises. With irrigation, farmers can grow and sell as many as three to four high value vegetable crops every year and ensure that the crop is ready for market when the price is high. The MoneyMaker pressure pump provides farmers a pump that can push water uphill as well as simply pulling it up from the source. This means it is suitable for use on steeply sloping land where the water source may be at the bottom.",
...
const politics = {
    1: {
        ...
        "architect": "Haas&Hahn",
        "description": "The Dutch art collective haas&hahn (jeroen koolhaas and dre urhahn), founded the favela painting project, which aims at turning public urban spaces in communities facing social difficulties into monumental works of art. The art of favela painting is not about cosmetically ‘camouflaging’ an area, but rather rejuvenating deprived areas of a city and creating a positive social effect on the general district at hand. It is a means of imagination and rethinking, redesigning and rebranding a community at whole.",
    ...
    4: {
        ...
        "description": "In 2006 a local study labeled Steve Casey's Chicago neighborhood a food desert—a term used to describe areas that lack affordable fresh produce (but are usually awash in burger wrappers and French-fry containers). Fresh Moves Mobile Market is a single-aisle grocery store located in an unlikely venue: a retrofitted Chicago Transit Authority bus, which was purchased from the city for $1. Architecture for Humanity Chicago partnered with local nonprofit Food Desert Action to design the bus, which brings fresh produce to the 500,000 Chicago residents living in neighborhoods that are classified as food deserts.",
    ...
    5: {
        ...
        "description": "Violence prevention through urban upgrading; using social engagement and town planning as tools in fighting crime. The Violence Prevention through Urban Upgrading project (VPUU) is an urban planning design strategy in Cape Town Khayelitsha Township, which uses social engagement and town planning as tools in fighting crime. The project is based on the belief that proper design and effective use of the built environment will lead to a reduction in crime and the fear of crime.",
